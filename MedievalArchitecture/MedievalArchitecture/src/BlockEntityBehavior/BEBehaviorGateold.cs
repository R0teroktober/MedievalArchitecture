...
//public class GateTextureSource : ITexPositionSource
//{
...
//    {
//        get { return blockTextureSource[curType + "-" + textureCode]; }
//    }
//}

//public class BEBehaviorGateold : BEBehaviorAnimatable, IInteractable, IRotatable
//{

//    private bool opened;
//    private string type;
//    private string defaultType = "oak";
//    public string Type => type ?? defaultType;

//    private MeshData animatableOrigMesh;
//    private MeshData mesh;
//    private Shape animatableShape;
//    private string animatableDictKey;
...
//    public BEBehaviorGateold(BlockEntity blockentity) : base(blockentity)
//    {
//    }
...
//        defaultType = Blockentity.Block.Attributes?["defaultType"]?.AsString("oak") ?? "oak";
//        type ??= defaultType;
...
//    {
//        ApplyPlacementData(rotDeg, type);
//    }

//    public void SetType(string newType)
//    {
//        ApplyPlacementData(RotDeg, newType);
//    }

//    private MeshData GenTypedMesh(ICoreClientAPI capi, Shape shape)
//    {
//        var texSource = new GateTextureSource()
//        {
//            blockTextureSource = capi.Tesselator.GetTextureSource(Blockentity.Block),
//            curType = type ?? defaultType
//        };
...
//        capi.Tesselator.TesselateShape(meta, shape, out MeshData genMesh);
//        return genMesh;
//    }

//    public void ApplyPlacementData(int rotDeg, string newType)
//    {
//        RotDeg = GameMath.Mod(rotDeg, 360);
//        type = string.IsNullOrEmpty(newType) ? defaultType : newType;

//        animatableOrigMesh = null;
//        animatableShape = null;
//        animatableDictKey = null;
...
//        string animKey = "gate-" + Blockentity.Block.Code.ToShortString() + "-" + (type ?? defaultType);

//        if (animatableOrigMesh == null || animatableDictKey != animKey)
//        {
//            // Shape über den bestehenden AnimUtil-Weg auflösen
//            animUtil.CreateMesh(animKey + "-probe", null, out Shape shape, null);

//            animatableShape = shape;
//            animatableOrigMesh = GenTypedMesh(capi, animatableShape);
...
//    {
//        if (animatableOrigMesh == null) return;
...
//        type = tree.GetString("type", type ?? defaultType);
...
//        {
//            if (beforeRotDeg != RotDeg || beforeType != type)
//            {
//                animatableOrigMesh = null;
//                animatableShape = null;
//                animatableDictKey = null;
...
//        tree.SetString("type", type ?? defaultType);
//    }
